...
const RightDrawer = ({open, onClose}) => {
  ...
  return (
    <Drawer 
        ...
        <div className='md:w-[600px] px-[2rem] border-b-1 border border-gray-200'>Your Cart</div>
        ...
        <section className="relative w-[100%]  p-[2rem] flex flex-col md:flex-row gap-[1rem] bg-white ">
            ...
            <div className="w-[50%] text-[14px] flex flex-col">
